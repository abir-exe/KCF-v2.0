    ...
    <footer className="mt-20">
      <footer className="footer p-10 bg-base-200 text-base-content">
        <nav>
          ...
          <a className="link link-hover">Chemical and Medicine ingredients</a>
        </nav>
        <nav>
        ...
        <nav>
          <header className="footer-title mb-4 flex items-center">
            {" "}
            Address
          </header>

          <a className="link link-hover mt-3 border-b">
